...
namespace ConsoleTables
{
    public class ConsoleTable
    {
        ...
        public string ToStringAlternativeAddition()
        {
            var builder = new StringBuilder();
        ...
        public string ToStringAlternativeMultiplication()
        {
            var builder = new StringBuilder();
        ...
        public string ToStringAlternativeDivision()
        {
            var builder = new StringBuilder();
        ...
        public void Write(Format format = ConsoleTables.Format.AlternativeSubstraction)
        {
            switch (format)
            {
                case ConsoleTables.Format.AlternativeSubstraction:
                    Console.WriteLine(ToString());
                    break;
                case ConsoleTables.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case ConsoleTables.Format.AlternativeAddition:
                    Console.WriteLine(ToStringAlternativeAddition());
                    break;
                case ConsoleTables.Format.Minimal:
                    Console.WriteLine(ToMinimalString());
                    break;
                case ConsoleTables.Format.AlternativeMultiplication:
                    Console.WriteLine(ToStringAlternativeMultiplication());
                    break;
                case ConsoleTables.Format.AlternativeDivision:
                    Console.WriteLine(ToStringAlternativeDivision());
                    break;
                default:
    ...
    public class ConsoleTableOptions
    {
        ...
        /// </summary>
        public Alignment NumberAlignment { get; set; } = Alignment.Right;
    }

    public enum Format
    {
        AlternativeSubstraction = 0,
        MarkDown = 1,
        AlternativeAddition = 2,
        Minimal = 3,
        AlternativeMultiplication = 4,
        AlternativeDivision = 5
    }
